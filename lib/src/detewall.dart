...
class Detewall extends StatefulWidget {
  const Detewall({Key? key}) : super(key: key);

  @override
  State<Detewall> createState() => _DetewallState();
}

class _DetewallState extends State<Detewall> {
  @override
